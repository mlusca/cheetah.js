...
Use this site for user-facing documentation: guides, examples, API explanations, package-specific documentation, and architecture positioning. The repository root README should stay concise and point readers here for implementation guidance.
...
- Keep technical claims contextual and supported by relevant examples.
