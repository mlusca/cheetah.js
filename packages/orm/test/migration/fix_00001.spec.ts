...
import { BaseEntity, Entity, ManyToOne, Migrator, PrimaryKey, Property } from '../../src';
import { v4 } from 'uuid';
...
describe('error on length', () => {
  ...
  test('1', async () => {
    ...
    expect(migrationContent).toContain('ALTER TABLE "public"."user" ALTER COLUMN "password" TYPE character varying(20);\n' +
